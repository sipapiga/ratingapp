...
let sqltable = 'CREATE TABLE IF NOT EXISTS restaurang(id int(5) NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL,location varchar(255) NOT NULL, price varchar(255) , rating decimal(10,2),image varchar(255),url varchar(255),phonenumber  varchar(255),category  varchar(255),PRIMARY KEY (id))';
